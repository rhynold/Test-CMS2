...
/**
 * Title: Query
 * Slug: block-theme-default/query
 * Categories: posts
...
<div class="wp-block-query">
	<!-- wp:post-template -->
		...
		<!-- wp:pattern {"slug":"block-theme-default/hidden-post-meta"} /-->
	...
	<!-- /wp:post-template -->
	<!-- wp:query-no-results -->
	<!-- wp:paragraph --><p><?php esc_html_e( 'No results found.', 'block-theme-default'); ?></p><!-- /wp:paragraph -->
	<!-- /wp:query-no-results -->
